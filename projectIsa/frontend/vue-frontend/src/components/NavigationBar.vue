        ...
        <div id="nav">
            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <router-link v-if="isLoggedIn ==='Client' || isLoggedIn ==='Administrator' || isLoggedIn ==='FishingInstructor'"  v-on:click="logout" to="/" class="nav-item nav-link">Logout</router-link>
                    </div>
            </nav>
        </div>
        <router-view />
